...
@interface TGActionTool()<UIAlertViewDelegate, UIActionSheetDelegate>



@end

@implementation TGActionTool
...
+ (void)showTipAlertViewWith:(UIViewController *)viewController
    ...
    if (btnTitle) {
        ...
        switch (btnStyle) {
            case TGTAlertActionStyleDefault:
