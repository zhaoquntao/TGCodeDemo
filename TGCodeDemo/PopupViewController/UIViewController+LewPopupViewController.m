...
//        [backgroundView addGestureRecognizer:tap];
    ...
    popFrame = self.lewPopupView.frame;
...
{
    CGRect frame = self.lewPopupView.frame;
    frame.origin.y = popFrame.origin.y-52;
    [UIView animateWithDuration:0.3 animations:^{
        [self.lewPopupView setFrame:frame];
    }];
}
...
{
    [UIView animateWithDuration:0.3 animations:^{
        [self.lewPopupView setFrame:popFrame];
    }];
}
